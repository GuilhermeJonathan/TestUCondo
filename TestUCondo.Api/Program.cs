...
using TestUCondo.Application.Queries.CustomerModule.Handler;
...
using TestUCondo.Infra.Asaas.Service;
...
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(GetCustomersQueryHandler).Assembly));
...
builder.Services.Configure<AsaasSettings>(
